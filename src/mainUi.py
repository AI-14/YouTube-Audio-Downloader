...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.destination_button.setGeometry(QtCore.QRect(370, 10, 211, 41))
        font = QtGui.QFont()
        ...
        self.input_text.setGeometry(QtCore.QRect(210, 60, 571, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setBold(True)
        font.setItalic(False)
        ...
        self.add_list_button.setGeometry(QtCore.QRect(810, 60, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.clear_list_button.setGeometry(QtCore.QRect(840, 510, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.delete_button.setGeometry(QtCore.QRect(10, 510, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
